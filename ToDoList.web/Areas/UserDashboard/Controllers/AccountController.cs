    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (user != null)
            {
                ...
                viewModel.IsProjectOwnerCount = user.AsProjectOwner.Count();
                viewModel.IsScrumMasterCount = user.AsScrumMaster.Count(); 
            }
        ...
        public ActionResult Edit()
        {
            ...
            if (user != null)
            {
                var viewModel = new UserViewModel
                {
                    ...
                    Skills = user.Skills,
                    Notes = user.Notes,
                    IsProjectOwnerCount = user.AsProjectOwner.Count(),
                    IsScrumMasterCount = user.AsScrumMaster.Count(),
                    IsInTeamCount = user.InTeams.Count()                    
                };
                return View(viewModel);
            }
            else
